<!-- 
    ...
    Vue : Vue Créé par défaut par la cli  de Vue.js (J'ai juste enlever le link pour la faire apparaitre mais je l'ai laisser pour voir se que nous créé par défaut la cli)
-->
<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
